package fh.campus.asd.usermanagement.main.implementation;
...
import fh.campus.asd.usermanagement.exceptions.authetication.UserManagerSessionIdNotValidException;
import fh.campus.asd.usermanagement.exceptions.dataaccessor.UserManagerUserNotFoundException;
import fh.campus.asd.usermanagement.exceptions.datamanger.*;
import fh.campus.asd.usermanagement.interfaces.PasswordAuthenticatorIF;
...
public class UserManager implements UserManagerIF {
    ...
    public void createUserProfile(String firstName, String lastName, String userName, String password) throws UserManagerException {
        ...
        } catch (fh.campus.asd.usermanagement.exceptions.dataaccessor.UserManagerUserAlreadyExistException e) {
